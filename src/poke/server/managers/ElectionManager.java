...
public class ElectionManager implements ElectionListener {
	...
	public  HashMap<String,Integer> leader=new HashMap<String,Integer>();
	...
	public void concludeWith(boolean success, Integer leaderID) {
		if (success) {
           ...
           leader.put("leader",leaderID);
           System.out.println("leader in map"+leader.get("leader"));
		election.clear();
